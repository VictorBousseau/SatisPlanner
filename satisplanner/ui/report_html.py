...
def _sustainability(report: FactoryReport, game_data: GameData) -> str:
    ...
    return (
        f"<p class='banner'>CES DEBITS NE SONT PAS TENABLES — ils vivent sur un stock "
    ...
    if report.byproducts:
        ...
        for balance in report.byproducts:
            ...
            detail = (
                ...
                f"stocke {formatting.number(balance.stored)}, "
                f"exporte {formatting.number(balance.exported)}, "
